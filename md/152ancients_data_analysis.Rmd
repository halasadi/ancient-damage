...
plot(metadata_matched$min_date, pc_data_frame$PC.PC3, las=2, cex.axis=0.7, col="red", xlab="Min.date of ancients", ylab="PC3", main="PC3 vs age of ancients")

plot(metadata_matched$min_date, pc_data_frame$PC.PC2, las=2, cex.axis=0.7, col="red", xlab="Min.date of ancients", ylab="PC2", main="PC2 vs age of ancients")

plot(metadata_matched$min_date, pc_data_frame$PC.PC1, las=2, cex.axis=0.7, col="red", xlab="Min.date of ancients", ylab="PC1", main="PC1 vs age of ancients")
